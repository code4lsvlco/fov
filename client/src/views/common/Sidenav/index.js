...
import {
    toggleCollapsedNav
} from '../../../state/ducks/navigation/actions';
...
class Sidebar extends React.Component {
  ...
  componentDidMount() {
    ...
    const AutoCloseMobileNav = false;
    // if (APPCONFIG.AutoCloseMobileNav) {
    if (AutoCloseMobileNav) {
    ...
    return (
      <nav
        ...
        <section
          ...
          <Link to="/" className="brand">Louisville</Link>
        ...
        <section className="sidebar-footer">
          <ul className="nav">
            <li>
              <a target="_blank" href={"mailto:!!help@louisvilleco.gov"}>
